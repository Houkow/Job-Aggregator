        ...
        {recommended.length > 0 && (
          <section className={styles.section}>
            <div className={styles.sectionHeader}>
              ...
              <button className={styles.seeAll} onClick={() => setFilters((p) => ({ ...p, q: '' }))}>
                Voir tout →
              </button>
            </div>
              ...
              {visibleRecommended.map((offer) => (
                <div key={offer.id} className={styles.carouselCard}>
                  ...
                  <div className={styles.carouselInfo}>
                    ...
                    <p className={styles.carouselCompany}>{offer.company}</p>
                    <div className={styles.carouselMeta}>
                      <span className={styles.contractBadge}>{offer.contractType || 'CDI'}</span>
                      <span className={styles.carouselDate}>
                        {offer.createdAt
                          ? `Il y a ${Math.floor((Date.now() - new Date(offer.createdAt)) / 86400000)} jours`
                          : 'Récent'}
                      </span>
                    </div>
                  </div>
